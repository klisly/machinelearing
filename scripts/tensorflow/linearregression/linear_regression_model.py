...
class LinearRegressionModel:
    ...
    def next_batch(self, batch_size):
        ...
        return self._datas[start:end], self._lables[start:end]
    ...
    def predict(self, x_predict):
        pred_list = []
        for x_test_batch in self.predict_batch(x_predict, 10):

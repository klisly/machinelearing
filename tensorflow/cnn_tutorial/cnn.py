...
h_relu1 = tf.nn.relu(conv2d(x_input, W_conv1) + b_conv1)
h_pool1 = max_pool_2(h_relu1)

# define layer2
W_conv2 = weight_variable([5, 5, 32, 64])  # Weight in:32  out:64
b_conv2 = bias_variable([64])   # bias for 64 kernel
h_relu2 = tf.nn.relu(conv2d(h_pool1, W_conv2) + b_conv2)
h_pool2 = max_pool_2(h_relu2)
...
drop_fc1 = tf.nn.dropout(hfc1, keep_prob)
...
print("test accuray %g" % accuracy.eval(feed_dict={x: mnist.test.images, y_label: mnist.test.labels, keep_prob: 1.0}))
